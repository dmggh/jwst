#!/bin/csh
setenv PYTHONPATH /data1/CRDS/CRDS_server/webserver/python/lib/python/crds/server:/data1/CRDS/CRDS_server/webserver/thirdparty/lib/python:/data1/CRDS/CRDS_server/webserver/python/lib/python/crds/server:/data1/CRDS/CRDS_server/webserver/thirdparty/lib/python:/data1/CRDS/CRDS_server/webserver/python/lib/python:/home/jmiller/CRDS/CRDS_server/webserver/thirdparty/lib/python:/home/jmiller/CRDS/CRDS_server/webserver/python/lib/python:/data1/pyetc_third_party_5/lib/python
...
setenv SERVER_PORT 4997
setenv PATH /data1/CRDS/CRDS_server/webserver/python/bin:/data1/CRDS/CRDS_server/webserver/python/bin:/data1/pyetc_third_party_4/bin:/usr/stsci/Python-2.7.1/bin:/data2/iraf/pandokia/bin:/home/iraf/bin:/usr/kerberos/bin:/usr/local/bin:/bin:/usr/bin:/usr/X11R6/bin
