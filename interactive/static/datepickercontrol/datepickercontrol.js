...
DatePickerControl.init = function()
{
	...
	// document.writeln("<h2>DatePickerControl hello!<h2>");
...
DatePickerControl.createButton = function(input, useId)
{
	...
	*/
	...
	calButton.src = "/site_media/datepickercontrol/calendar_icon.png";
...
DatePickerControl.getHeaderCode = function()
{
	...
	vCode += "<span class='yearbutton' title='" + this.Months[prevMM] + " " + prevYYYY + "' ";
	vCode += "onclick='DatePickerControl.build(" + prevMM + ", " + prevYYYY + ");return false;'>&nbsp; &nbsp; &laquo;</span>";

	vCode += "&nbsp; &nbsp;" + this.monthName + "&nbsp;&nbsp;";

	vCode += "<span class='yearbutton' title='" + this.Months[nextMM] + " " + nextYYYY + "' ";
